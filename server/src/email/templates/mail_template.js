            ...
            <table cellpadding="0" cellspacing="0" style="border-spacing:0;border-collapse:collapse;">
              <tbody>
                <tr>
                  <td style="width:180px;height:60px;line-height:0;"></td>
                  <td style="width:250px;height:60px;">
                    <a href="http://192.168.219.106:5173/users/updatePwd?email=%%email%%&token=%%token%%" style="padding:20px 0 20px;display:block;line-height:60px;font-weight:bold;font-size:18px;background-color:#1d4ed8;text-decoration:none;color:#fff;text-align:center;border:0">
                      비밀번호 수정하기
                    </a>
                  </td>
                  <td style="width:180px;height:60px;line-height:0;"></td>
...
module.exports = {authMail, findPassword}