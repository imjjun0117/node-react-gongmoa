...
<div>
  <table width="750" cellpadding="0" cellspacing="0" style="border-spacing:0;border-collapse:collapse;margin:0 auto;background-color:#fff;border:5px solid #e7e7e7;box-sizing:border-box;font-family:맑은 고딕;letter-spacing:-1px;line-height:1.4em;">
    <!-- HEADER -->
    <thead><tr><th colspan="1" rowspan="2" style="width:65px;height:52px;line-height:0;"></th><th colspan="1" rowspan="1" style="height:52px;padding:48px 0 20px 0;border-bottom:2px solid #666;text-align:left;">
        ...
        </th><th colspan="1" rowspan="2" style="width:65px;height:52px;line-height:0;"></th></tr><tr><td style="padding:40px 0 0;text-align:left;line-height:45px;color:#333;font-size:36px;">이메일 인증 번호가 <br> 발급되었습니다.</td></tr></thead>
    <!-- CONTENTS -->
    <tbody><tr><td rowspan="3" style="width:65px;"></td><td style="padding:85px 0 30px;text-align:left;line-height:28px;color:#333;font-size:20px;">
          ...
          <table cellpadding="0" cellspacing="0" style="border-spacing:0;border-collapse:collapse;">
            <tbody><tr><td style="width:180px;height:60px;line-height:0;"></td><td style="width:250px;height:60px;">
                  <button type="button" style="display:block;width:250px;height:60px;line-height:60px;font-weight:bold;font-size:18px;background-color:#1d4ed8;text-decoration:none;color:#fff;text-align:center;border:0">
                    공모아 홈페이지 로그인
                  </button>
                </td><td style="width:180px;height:60px;line-height:0;"></td></tr></tbody>
          </table>
        </td></tr></tbody>
    <!-- FOOTER -->
    <tfoot><tr><td colspan="3" style="padding:30px 65px;text-align:left;line-height:23px;color:#333;font-size:16px;">
          본 메일은 발신전용입니다. <br>
          공모아 회원가입 신청을 위한 본인인증 메일이며, <br>
          신청자가 이메일을 잘 못 기입하여 원하지 않는 메일을 받게 되셨을 경우 해당 메일을 <br>
          즉시 삭제해주시기 바랍니다.
        </td></tr><tr><td colspan="3" style="padding:40px 65px;background-color:#e7e7e7;text-align:left;line-height:20px;color:#999;font-size:14px;">
