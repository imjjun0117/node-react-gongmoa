...
const AccountItem = () => {
  ...
  return (
    <Menu>
      <MenuHandler className='flex items-center text-white mr-5 text-2xl'>
          <button ><VscAccount /></button>
      </MenuHandler>
      <MenuList className='z-30 mt-3'>
        
        <MenuItem className="flex items-center gap-2 px-4 py-2">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <MenuItem className="flex items-center gap-2 px-4 py-2">
          ...
          <Typography variant="small" className="font-medium" onClick={onLogoutHandler}>
            로그아웃
          </Typography>
        </MenuItem>
      </MenuList>
