        ...
        <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-white">이메일</label>
                <input
                  type="email"
                  name="email"
                  id="email"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="remember" className="text-gray-300">로그인 상태 유지</label>
                  </div>
                </div>
                <a href="/users/findPwd" className="text-sm font-medium text-primary-600 hover:underline text-blue-300">비밀번호를 잊으셨나요?</a>
              </div>
              <button
                type="submit"
              ...
              <div className="flex items-center my-6">
                ...
                <span className="mx-4 text-sm font-light text-gray-400">또는</span>
                <div className="flex-grow border-t border-gray-600"></div>
              </div>
              <KakaoBtn/>
