...
export function AdminMenuModify({fetchRoutes}) {
    ...
    if(dataStatus){
      ...
      if(act === 'U'){
        ...
        if(code){
          ...
          axiosInstance.get('/admin/admin_menu/getAdminMenuDetail', {params}).then(res => {
        ...
        axiosInstance.get('/admin/admin_menu/getAdminMenuCode', {params}).then(res => {
  ...
  const onSubmit = ({ menu_name, menu_path, use_yn}) => {
    ...
    if(submitStatus){
      ...
      axiosInstance.post('/admin/admin_menu/modifyAdminMenu', body).then(res => {
        ...
        if(res.data.success){
          ...
          fetchRoutes();
          navigate(`/aoslwj7110/admin_menu?p_code=${pCode ? pCode : ''}`)
        }
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-end p-5">
              <Link to={`/aoslwj7110/admin_menu?p_code=${pCode ? pCode : ''}`}>
                <Button
