...
export function UserMenu({fetchRoutes}) {
  ...
  const fetchMenuList = async() => {
    ...
    if(dataStatus){
      ...
      //메뉴 리스트 호출
      await axiosInstance.get('/admin/user_menu/userMenuList', {params}).then(res => {
  ...
  const setStatus = (e, menu_code) => {
    ...
    //상태변경 서버
    axiosInstance.post('/admin/user_menu/setUserMenuStatus', body).then(async(res) => {
  ...
  const goNextDepth = (menu_code) => {
    ...
    navigate(`/aoslwj7110/user_menu?p_code=${menu_code}`)
  }
  ...
  const setOrder = () => {
    ...
    axiosInstance.post('/admin/user_menu/setUserMenuOrder', body).then(res => {
  ...
  return (
    <div className="mt-48 mb-8 flex flex-col gap-12">
      <Card>
        <CardHeader variant="gradient" color="gray" className="mb-8 p-6">
          <Typography variant="h6" color="white">
            사용자 메뉴 관리 ({parentName})
          </Typography>
        </CardHeader>
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          {
            parentName !== '최상위' && (
              <Link to="/aoslwj7110/user_menu">
                ...
                ({ menu_code, name, reg_dt, update_dt, use_yn }, key) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={className}>
                        <Link to={`/aoslwj7110/user_menu/modify?act=U&code=${menu_code}&p_code=${pCode ? pCode : ''}`}>
                          <Typography
                            as="a"
                            href="#"
          ...
          <div className='flex justify-end mt-5 mr-8'>
            ...
            <Link to={`/aoslwj7110/user_menu/modify?act=I&code=${pCode ? pCode : ''}&p_code=${pCode ? pCode : ''}`}>
